...
abstract class CustomLightDiskTopTheme {
  CustomLightDiskTopTheme._();
  ...
  static const TextStyle _customHintText = TextStyle(
      color: LightColor.hint, fontSize: 18, fontWeight: FontWeight.normal);
  static const TextStyle _customErrorText = TextStyle(
      color: LightColor.error, fontSize: 17, fontWeight: FontWeight.normal);
...
abstract class CustomDarkDiskTopTheme {
  CustomDarkDiskTopTheme._();
  ...
  static const TextStyle _customHeadline1 = TextStyle(
      ...
      fontWeight: FontWeight.normal);
  static const TextStyle _customHintText = TextStyle(
      color: DarkColor.hint, fontSize: 18, fontWeight: FontWeight.normal);
  static const TextStyle _customErrorText = TextStyle(
      color: DarkColor.error, fontSize: 17, fontWeight: FontWeight.normal);
